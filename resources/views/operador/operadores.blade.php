    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <table class="table table-hover table-sm table-striped" id="operadoresTable">
...
{{--                    @endforeach--}}
    ...
    <!-- Modal -->
    <div class="modal fade" id="operadoresModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
@endsection
@section('scripts')
    <script src="{{asset('js/operador/operadores.js')}}"></script>
    @endsection