...
class ClientesController extends Controller
{
    public function getClientes(){
        ...
        return Datatables::of($clientes)->editColumn('dia_revision', function($row) {
            foreach (Constantes::DIAS_SEMANA as $index=>$valor){
                if($row->dia_revision == $index){
                    $dia = $valor;
                }
            ...
            ->addColumn('actions', 'cliente/actions')
            ->rawColumns(['actions'])
            ->make(true);
    }
    /**
    ...
    public function show($id)
    {
        ...
        return view('cliente/partial')->with('cliente', $cliente);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente/clienteEdit')->with('cliente', $cliente)->with('id',$id)->with('dias', Constantes::DIAS_SEMANA);
    }
